...
//   return (
//     <header
//       className={`fixed top-0 left-0 w-full z-50 px-4 py-2 transition-transform duration-500 ${
//         showNavbar ? "translate-y-0" : "-translate-y-full"
//       }`}
//     >
//       <nav className="max-w-7xl mx-auto bg-white/70 backdrop-blur-xl border border-pink-200 rounded-2xl shadow-lg">
...
//                 <a
//                   href={item.href}
//                   className="text-gray-700 font-medium hover:text-pink-500 transition duration-300"
//                 >
//                   {item.name}
//                 </a>
//               </li>
...
//         {/* Mobile Menu */}
//         {open && (
//           <div className="lg:hidden border-t border-pink-100">
...
//                 className="block px-6 py-4 text-gray-700 hover:bg-pink-50 hover:rounded-2xl hover:text-pink-600 transition"
//               >
//                 {item.name}
//               </a>
//             ))}
