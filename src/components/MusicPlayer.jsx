...
// const songs = [
//   { name: "Love 1 💖", src: "/music/love1.mpeg" },
//   { name: "Love 2 💕", src: "/music/love2.mpeg" },
//   { name: "Love 3 💓", src: "/music/love3.mpeg" },
//   { name: "Love 4 🌸", src: "/music/love1.mpeg" },
//   { name: "Love 5 ✨", src: "/music/love3.mpeg" },
//   { name: "Love 6 💫", src: "/music/love1.mpeg" },
//   { name: "Love 7 💗", src: "/music/love2.mp3" },
// ];
...
//   className="fixed bottom-5 right-5 z-50 bg-pink-500 hover:bg-pink-600 text-white p-3 rounded-full shadow-xl music-bounce"
// >
//   <FaMusic size={20} />
// </button>
...
//       {/* 🎶 GLASS PANEL */}
//       {open && (
//         <div ref={panelRef} className="fixed bottom-4 right-4 w-60 bg-white/30 backdrop-blur-xl border border-pink-200 rounded-2xl shadow-2xl z-50 flex flex-col">

//           {/* HEADER */}
//           <div className="flex justify-between items-center px-3 py-2 border-b border-pink-100">
//             <span className="text-xs text-pink-600 font-semibold">
//               🎶 Playlist
//             </span>

//             <button onClick={() => setOpen(false)}>
//               <FaTimes className="text-pink-500 text-sm" />
//             </button>
//           </div>

//           {/* SONG LIST (SCROLL ENABLED) */}
//           <div className="max-h-40 overflow-y-auto p-2 space-y-2 scrollbar-thin scrollbar-thumb-pink-300 scrollbar-track-pink-100 scrollbar-thumb-rounded-full scrollbar-track-rounded-full hover:scrollbar-thumb-pink-600">

//             {songs.map((song, i) => (
//               <button
//                 key={i}
//                 onClick={() => playSong(song)}
//                 className="w-full flex justify-between items-center bg-white/40 hover:bg-pink-100/40 rounded-lg px-2 py-1"
//               >
//                 <span className="text-[11px] text-pink-700 truncate">
//                   {song.name}
//                 </span>
...
//               <button
//                 onClick={pauseSong}
//                 className="w-full bg-pink-500 text-white py-1 rounded-full text-xs"
//               >
//                 ⏸ Pause
//               </button>
//             ) : (
...
//                 className="w-full bg-white/50 text-pink-600 py-1 rounded-full text-xs"
//               >
//                 ▶ Play
//               </button>
//             )}
